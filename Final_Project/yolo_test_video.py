...
class_name = []
with open('yolo_name.txt', 'r') as f:
...
cap = cv.VideoCapture('video_test2.mp4')
...
print(dim)
out = cv.VideoWriter('video_out.avi', fourcc, 30.0, dim)
...
# References: https://github.com/Asadullah-Dal17/yolov4-opencv-python/blob/master/yolov4.py